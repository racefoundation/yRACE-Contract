...
//         uint256 allocPoint; // How many allocation points assigned to this pool. yRaces to distribute per block.
//         uint256 lastRewardBlock; // Last block number that yRaces distribution occurs.
//         uint256 rewardPerShare; // Accumulated yRaces per share, times 1e12. See below.
//     }
...
//         require(poolId1[address(_lpToken)] == 0, "YraceLPMaster::add: seed pool is already in pool");
//         if (_withUpdate) {
//             massUpdatePools();
//         }
...
//     // Update the given pool's yRace allocation point. Can only be called by the owner.
...
//     //     require(_newOwner != address(0) && _newOwner != yRace.owner(),"Invalid Owner Address");
//     //     yRace.transferOwnership(_newOwner);
//     // }
// }